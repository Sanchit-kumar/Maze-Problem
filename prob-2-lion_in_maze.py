...
def search_algo(n, maze, start, end):
    ...
    queue=[];
    queue.append((pos,0,"start",pos)); #(present position, cost , move, parent position) format is entered to the stack
    while len(queue)>0:
# =============================================================================        
        item=queue.pop(0)
        pos=item[0]
...
# =============================================================================
    ...
    print("Note:-- Green boxes is the path taken by BFS ")
    print("Note:---DeepSkyBlue2 are the boxes visited, (also present in queue) but not taken by algo")
